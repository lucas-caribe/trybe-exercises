...
// Dica: Você pode acessar o index do array dentro de map , e você pode ver o objeto esperado
// na constante expected .
function studentAverage() {
  return grades.map((studentGrades, index) => ({
    name: students[index],
    average:
      studentGrades.reduce((sum, current) => sum + current, 0) /
